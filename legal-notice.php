...
<head>
    <?php
        include("./meta.php");
    ?>
    <link rel="preload" href="legal-notice-style.css" as="style">
    ...
    <section id="notice-list">
        <ul>
            ...
            <li>
                <h2>Siège social</h2>
                <p>
                    2 Rue Albert Einstein, 77420 Champs-sur-Marne (FR)
                </p>
            </li>
            <li>
                <h2>Hébergeur</h2>
            ...
            <li>
            <h2>Habillage du site</h2>
            <p>
                L’habillage du site a été réalisé par Athénaïs MEZLOY, Lilian PEURON, Bruno MARTINS DA COSTA et Timothé
                BUREAU.
            </p>
            </li>
            <li>
            <h2>DPO-Collecte de données</h2>
            <p>
                Athénaïs MEZLOY <br>
                Adresse courriel : athenais.mezloy@gmail.com <br>
                Adresse postale : 21 chemin des Chênes, 93160 Noisy-le-Grand (FR) <br><br>

                Le DPO peut exercer sur les données recueillies le droit de modification, le droit d’accès, le droit de
                suppression, le droit d’oubli ainsi que le droit à la portabilité. <br><br>

                Lorsque les visiteurs laissent des commentaires sur le site, nous recueillons les données indiquées dans
            ...
            <li>
            <h2>Autorisation du droit à l’image pour les vidéos et images</h2>
            <p>Chaque personne dont l'image apparaît sur le site certifie l’autorisation du droit à l’image.</p>
            </li>
            <li>
            <h2>Médias</h2>
            <p>Les images téléchargées sur notre site ne pourront faire l’objet d’aucune autre utilisation. La
                responsabilité de notre site n’est en aucun cas engagée.</p>
            </li>
            <li>
