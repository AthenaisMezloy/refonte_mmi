...
<section id="general-program">
    <div class="intro">
        ...
        <p class="citation">Citation - Une citation pour décrire le programme là.</p>
    ...
    <div class="bloc">
        <div class="dev" >
        <a href=""alt="Développement Web" >Développement Web</a></div>
        <div class="design" >
        <a href=""alt="Design" >Design</a></div>
        <div class="audio" >
        <a href=""alt="Audiovisuel" >Audiovisuel</a></div>
        <div class="com" >
        <a href=""alt="Communication" >Communication</a></div>
    </div>
</section>
<section id="schooling">
    <div class="intro">
        <h2>Parcours</h2>
        <p class="citation">Citation - Deux parcours. Deux horizons. Un avenir prometteur.</p>
...
<section id="MMIday">
    <div class="intro">
        ...
        <p class="citation">Citation - Des horaires de bureau, une perspective prometteuse.</p>
    </div>
    <div class="bloc3">
...
<section id="team">
        <div class="intro">
            ...
            <p class="citation">Citation - Une équipe à l’écoute. Des enseignants passionnés.</p>
    
        </div>
    <div class='slider'>
        <div class='item'><img src="gaellecharpentier.webp" alt=""></div>
